...
\begin{itemize}
  ...
  \vspace{2em}
  \item Introduce randomization $\ \ \longrightarrow\ \ $ random greedy algorithm
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item Non-adaptive: Choose set of locations in advance without looking at outcomes
  \vspace{2em}
  \item Adaptive: Sequentially make choices based on past outcomes
  \vspace{2em}
  \item Monotonicity and submodularity $\ \ \longrightarrow\ \ $ adaptive monotonicity and adaptive submodularity
  \vspace{2em}
  \item Adaptive greedy: Select the most promising location in conditional expectation
\end{itemize}
\end{frame}
