...
\includegraphics<5>[width=2in]{figures/sets.pdf}
\end{columns}
\end{frame}
...
\begin{itemize}
  ...
  \vspace{2.5em}
  \item<3-> Greedy has no guarantees for non-monotone functions
  \vspace{2.5em}
  \item<4-> Introduce randomization $\ \ \longrightarrow\ \ $ \emph{random greedy} algorithm
\end{itemize}
\end{frame}
